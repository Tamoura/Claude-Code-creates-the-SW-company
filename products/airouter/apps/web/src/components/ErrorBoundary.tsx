    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
          <div className="bg-card-bg border border-card-border rounded-lg shadow-lg p-8 max-w-md w-full">
            <div className="text-center">
              ...
              {this.state.error && import.meta.env.DEV && (
                <details className="text-left mb-6">
                  ...
                  <pre className="mt-2 text-xs bg-code-bg p-3 rounded overflow-auto max-h-40 text-text-secondary">
              ...
              <button
                ...
                className="bg-accent-blue text-white py-2 px-6 rounded-lg hover:opacity-90 transition-colors"
              >
                Go to Homepage
              </button>
            </div>
