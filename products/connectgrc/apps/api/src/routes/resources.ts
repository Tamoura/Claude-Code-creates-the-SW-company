...
const resourceRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get<{
    ...
    return reply.send(paginatedResult(resources, total, pagination)); // nosemgrep: javascript.express.security.audit.xss.direct-response-write.direct-response-write
  });
