...
const talentLinks: SidebarLink[] = [
  ...
  { label: 'Assessment', href: '/assessment', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  { label: 'Career', href: '/career', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
...
const adminLinks: SidebarLink[] = [
  ...
  { label: 'Frameworks', href: '/admin/frameworks', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
...
interface SidebarProps {
  variant?: 'talent' | 'admin';
}

export default function Sidebar({ variant = 'talent' }: SidebarProps) {
  const pathname = usePathname();
  const links = variant === 'admin' ? adminLinks : talentLinks;
    ...
    <aside className="w-64 bg-white border-r border-gray-200 min-h-screen hidden lg:block">
      <div className="p-4">
        <Link href="/" className="flex items-center gap-2 mb-8">
          ...
          <span className="font-bold text-lg text-primary">ConnectGRC</span>
        </Link>
