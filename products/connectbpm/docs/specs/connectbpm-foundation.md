...
| US-44 | Exercise the product on a free tier | S-01 | P1 | **G** a Sandbox tenant **W** it operates **T** one published process, 50 completed instances per period (DEC-007), a mandatory hard cap, unlimited free participants, and full evidence capture with a shortened retention window |
