...
| ASM-007 | The ConnectSW agent team sustains a delivery rate of one sprint per calendar week at the quality bar in Article III | The 14-sprint MVP estimate in §8.3 is optimistic | Measure actual sprint throughput across the first three sprints and re-baseline the estimate at the Foundation checkpoint |
