...
export default function JobsPage() {
  ...
  const filterChipCls = (isActive: boolean) =>
    [
      "rounded-full border px-4 py-1.5 text-sm font-medium transition-all duration-[180ms] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2",
      isActive
