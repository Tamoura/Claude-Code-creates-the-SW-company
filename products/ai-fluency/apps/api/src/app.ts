...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  // Registered before JWT and plugins so headers are set on ALL responses.
  // contentSecurityPolicy disabled in Sprint 1 — configure per-product in Sprint 2
  // when the frontend routes and CDN domains are finalized.
