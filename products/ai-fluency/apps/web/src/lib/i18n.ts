...
const translations: Record<string, string> = {
  ...
  'home.hero.subtitle':
    'AI Fluency assesses your team\'s ability to work effectively with AI across four key dimensions: conceptual understanding, practical application, critical thinking, and collaborative use.',
  ...
  'home.features.assess.description':
    'Measure conceptual understanding, practical skills, critical thinking, and collaborative AI use.',
