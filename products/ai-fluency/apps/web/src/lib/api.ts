...
// - CSRF protection is handled via SameSite=Strict cookies on the backend
//   (see apps/api/src/app.ts — no /csrf-token endpoint is registered)
// TODO: Implement explicit CSRF token endpoint in a future sprint if needed
