...
const dimensions = [
  {
    name: 'Delegation',
    description:
      'Tests your ability to appropriately delegate tasks to AI and identify when AI assistance is suitable.',
    questionCount: 15,
  },
  {
    name: 'Description',
    description:
      'Evaluates how clearly you can describe tasks and craft effective prompts for AI systems.',
    questionCount: 15,
  },
  {
    name: 'Discernment',
    description:
      'Assesses your ability to critically evaluate AI outputs, identify errors, and spot biases.',
    questionCount: 12,
  },
  {
    name: 'Diligence',
    description:
      'Measures your commitment to responsible, ethical, and thorough AI use in your work.',
    questionCount: 8,
  },
];
