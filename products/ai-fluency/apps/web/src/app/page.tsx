...
const dimensions = [
  { name: 'Delegation', score: 78, description: 'Delegating tasks appropriately to AI' },
  { name: 'Description', score: 65, description: 'Crafting clear prompts and task descriptions' },
  { name: 'Discernment', score: 82, description: 'Evaluating AI outputs and identifying risks' },
  { name: 'Diligence', score: 70, description: 'Responsible and thorough AI use' },
];
