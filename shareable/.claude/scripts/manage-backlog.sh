...
usage() {
  ...
  echo ""
  echo "Examples:"
  echo "  $0 sprint taskflow"
  echo "  $0 board taskflow"
  echo "  $0 add-story taskflow FEAT-001 'As a user, I can...' 5"
  echo "  $0 update taskflow STORY-001 done"
  echo "  $0 velocity taskflow"
  exit 1
}
