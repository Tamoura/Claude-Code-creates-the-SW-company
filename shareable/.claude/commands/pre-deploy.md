...
```
$PRODUCT_DIR/docs/quality-reports/pre-deploy-[YYYY-MM-DD].md
```
...
| `/compliance-check` | Regulatory compliance for financial products. Must pass before `/pre-deploy` for `taskflow` and `riskdesk`. |
