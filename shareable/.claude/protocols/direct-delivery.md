...
**Examples**:
```
products/taskflow/.claude/deliverables/BA-01-business-analyst-report.md
products/taskflow/.claude/deliverables/SPEC-01-product-manager-report.md
products/taskflow/.claude/deliverables/ARCH-01-architect-design.md
products/taskflow/.claude/deliverables/QA-01-qa-engineer-test-report.md
```
...
deliverable_path: "products/taskflow/.claude/deliverables/ARCH-01-architect-design.md"
```
...
### Summary
Architecture design is complete for taskflow. The architect designed a
...
|------------|-------|------|
| Architecture Design | Architect | `products/taskflow/.claude/deliverables/ARCH-01-architect-design.md` |
| API Contract | Architect | `products/taskflow/docs/API.md` |
| ADR-001: Service Split | Architect | `products/taskflow/docs/ADRs/001-service-architecture.md` |
