...
├────────────────────────────────┼──────────┼───────────┤
│ taskflow             │ Active   │ 🟢 Healthy│
│ talentgraph                      │ Active   │ 🟢 OnTrack│
│ riskdesk                     │ Dev      │ 🔵 InDev  │
│ quantum-explorer     │ Prototype│ 🔵 Planned│
└────────────────────────────────┴──────────┴───────────┘
...
1. **HIGH** - Backend Engineer for riskdesk
...
- 13:45 - DevOps: CI pipeline for riskdesk (60 min)
```
...
├──────────────────────┼───────┼─────────┼──────────┼─────────┤
│ talentgraph            │ 6     │ 720K    │ $36.00   │ 45%     │
│ riskdesk           │ 5     │ 560K    │ $28.00   │ 35%     │
│ taskflow   │ 2     │ 160K    │ $8.00    │ 10%     │
│ skillforge           │ 2     │ 160K    │ $8.00    │ 10%     │
└──────────────────────┴───────┴─────────┴──────────┴─────────┘
