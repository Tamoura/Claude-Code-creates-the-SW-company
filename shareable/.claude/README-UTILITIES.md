...
# Performance gate
.claude/quality-gates/executor.sh performance taskflow

# Testing gate
.claude/quality-gates/executor.sh testing taskflow

# Production readiness gate
.claude/quality-gates/executor.sh production taskflow
```
...
# Get ready tasks
get_ready_tasks "products/taskflow"

# Get parallel tasks
get_parallel_tasks "products/taskflow"

# Update task status
update_task_status "products/taskflow" "TASK-01" "completed"

# Validate task graph
validate_task_graph "products/taskflow"

# List all tasks
list_tasks "products/taskflow"
```
...
Task(
  ...
  prompt: `
    Run the testing gate for taskflow:
    
    Execute: .claude/quality-gates/executor.sh testing taskflow
