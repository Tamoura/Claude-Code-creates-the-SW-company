...
| "Add dark mode to talentgraph" | new-feature | PM → FE → QA |
| "Fix login timeout bug in talentgraph" | bug-fix | Support → BE/FE → QA |
| "Ship talentgraph to production" | release | DevOps → QA → Security |
...
| "Security review of archstudio" | security-review | Security + Code Reviewer |
