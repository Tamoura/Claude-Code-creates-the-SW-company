...
|---------|------------|-------------|
| `skillforge` | Assessment generation, skill gap analysis, learning path creation | Claude Sonnet |
| `codesentry` | Multi-model code review routing, quality scoring | Claude + OpenAI (planned) |
| `postpilot` | Post generation, trend analysis, Arabic/English translation | Claude Sonnet |
| `archstudio` | Architecture decision generation, ADR drafting | Claude Opus |
| `recommendly` | Content-based recommendation explanation | Claude Haiku |
